		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12">
						...
						<div class="row" v-if="!loading">
						<div class="col-md-12">
						<base-input type="text" label="" v-model="mapel.value" :validatedClass="$v.mapel.$error" placeholder="Masukkan mapel di sini"></base-input>
...
export default {
    ...
    methods: {
		...
		editData(id){
			this.mapel.value = this.data[id].mapel;
			this.mapel.id = this.data[id].id;
		},
		hapusData(id){
			if(this.data.length > 0){
				if(this.mapel.id != null){
					this.data.splice(id,1);
				}
				$axios
				.delete('/mapel/' + this.data[id].id)
				.then((response)=> {
		...
		simpanData(){
			if(this.mapel.value != null){
			  $axios
				.post('/mapel', { 'mapel' : this.mapel.value, 'id' : this.mapel.id })
				.then((response)=> {
				  var res = response.data;
